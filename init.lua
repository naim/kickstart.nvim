...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      -- Enable treesitter highlighting & indentation (Neovim builtins now)
      vim.api.nvim_create_autocmd('FileType', {
        callback = function()
  ...
  { -- Motions for moving around buffers quickly
    ...
    keys = {
      ...
      { "<leader>tl", mode = { "n", "x" }, function() require("flash").toggle() end, desc = "[T]oggle F[l]ash Search" },
    },
  },
  ...
  { -- Diagnostic, reference, telescope result, quickfix, and location list
    'folke/trouble.nvim',
  ...
  rocks = {
    -- Disable since it's not being used to clean up :checkhealth
    hererocks = false,
  },
  ui = {
